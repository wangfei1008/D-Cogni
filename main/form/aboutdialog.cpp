...
void AboutDialog::show(QWidget* parent, const QString& title, const QString& component, const QString& version)
{
    ...
    translatedTextAboutQtnCaption = QMessageBox::tr(
        "<h3>Data Cognitive Software</h3>"
        "<p>This program uses %1 version %2.</p>"
        ).arg(component).arg(version);

    QString translatedTextAboutQtText;
    translatedTextAboutQtText = QMessageBox::tr(
        "<p>Qtitan is a Qt/C++/Python framework for cross-platform application "
        "development.</p>"
        "<p>Qtitan provides single-source portability across MS&nbsp;Windows, "
        "Mac&nbsp;OS&nbsp;X, Linux (all major commercial variants).</p>"
        "<p>Series of a components Qtitan product of Developer Machines. See <a href=\"https://www.devmachines.com/\">www.devmachines.com</a> "
        "for more information.</p>"
        "<p>Copyright (c) 2009-2023 Developer Machines. All Rights Reserved.</p>"
        );
    ...
    QPixmap pm(QStringLiteral("res/image/logo48_48.png"));
    if (!pm.isNull())
